        ...
        NavigationStack {
            Form {
                Section("Account") {
                    ...
                    LabeledContent("Plan", value: "Epoch v0.1")
                }
                ...
                Section("Preferences") {
                    ...
                    NavigationLink {
                        ...
                        Label("About Epoch", systemImage: "info.circle")
                    }
                }
            }
            ...
            NavigationStack {
                ZStack(alignment: .top) {
                    ...
                    VStack(spacing: 8) {
                        ...
                        Text("Point your camera at the QR shown by `epoch init`.")
                            .font(.footnote)
...
private struct AboutEpochView: View {
    var body: some View {
        Form {
            Section("App") {
