...
final class AppStoreMessageActionsTests: XCTestCase {
    ...
    func testRetrySourceTextUsesPrecedingUserMessageForAssistantMessage() async throws {
        if ProcessInfo.processInfo.environment["EPOCH_ENABLE_LEGACY_MESSAGE_ACTION_TESTS"] != "1" {
            ...
            CodexUserMessageItem(
                ...
                content: [
                    ...
                    CodexUserInput(
                        ...
                        text: nil,
                        url: nil,
                        path: "/var/mobile/tmp/epoch-codex-inputs/photo-aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa.png"
                    ),
                ]
            )
        )
            ...
            CodexUserMessageItem(
                ...
                content: [
                    ...
                    CodexUserInput(
                        ...
                        text: nil,
                        url: nil,
                        path: "/Users/chan/.epoch/projects/proj/cache/codex-inputs/thr/bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb-photo.png"
                    ),
                ]
            )
        )
